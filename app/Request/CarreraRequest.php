...
function Agregar(){
	...
	<form action="<?=route($_POST['model'] . '/save'); ?>" method="POST" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="nombre" id="nombre" value="<?=utf8_encode($carrera->nombre); ?>" class="form-control" required>
			</div>

            <label for="siglas" class="col-sm-1 control-label">Siglas</label>
            <div class="col-sm-3">
                <input type="text" name="siglas" id="siglas" value="<?=$carrera->siglas; ?>" class="form-control" required>
            </div>
		</div>
